...
def store_user(request, user, user_photo, pfp_name):
    time_zone = 'UTC'
    ...
    request.session['user'] = {
        ...
        'user_metadata': user['displayName'],
        'photos': user_photo['Content-Type'] if user_photo else None,
        'pfp_name': pfp_name,
        'timeZone': time_zone
    }

    # request.session['user_photo'] = {
    #     'Location': user_photo['Location']
    # }
